...
Deno.serve(async (req) => {
  try {
    ...
    // Get user count (count unique created_by emails)
    const uniqueUsers = new Set(allStats.map(s => s.created_by)).size;
    
    // Define all global achievements and their tracking logic
