      ...
      <DialogContent className="sm:max-w-[500px] max-w-[95vw] max-h-[90vh] p-0 overflow-y-auto bg-gradient-to-br from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 [&>button]:hidden">
        ...
        <div className="relative bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 p-3 sm:p-4 text-white overflow-hidden">
          ...
          <div className="relative">
            <div className="pr-8">
              ...
              <p className="text-emerald-100 mt-0.5 text-[11px] sm:text-xs leading-tight">
                {context === "upgrade" 
            ...
            <button
              onClick={onClose}
              className="absolute top-0 right-0 w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-slate-800/80 hover:bg-red-600 transition-colors"
            >
        ...
        <div className="p-3 sm:p-4 space-y-2 sm:space-y-2.5">
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="flex items-center justify-center gap-1.5 p-0.5 sm:p-1 bg-slate-100 dark:bg-slate-900 rounded-lg">
              <button
              ...
              <button
                ...
                className={`flex-1 px-3 py-1.5 rounded-md text-xs sm:text-sm font-medium transition-all relative ${
              ...
              >
                Annual
                <Badge className="absolute -top-1.5 -right-1.5 bg-emerald-600 text-white text-[9px] sm:text-[10px] px-1 py-0 leading-tight">
                  Save 17%
                </Badge>
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
              {/* Free Plan Card */}
              <div className="p-2 sm:p-2.5 rounded-lg border-2 border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 relative">
                {!isPro && (
                  <Badge className="absolute -top-1.5 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[9px] whitespace-nowrap px-1.5 leading-tight">
                    Current Plan
                  </Badge>
                )}
                <h3 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white mb-0.5 text-center">Free Plan</h3>
                <div className="text-center mb-1.5 sm:mb-2">
                  <p className="text-lg sm:text-xl font-bold text-slate-600 dark:text-slate-400">$0</p>
                ...
                <div className="space-y-1">
                  ...
                  {/* Pro Plan Card */}
              <div className="p-2 sm:p-2.5 rounded-lg border-2 border-amber-500 dark:border-amber-600 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 relative overflow-hidden">
                {isPro && (
                  <Badge className="absolute -top-1.5 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[9px] whitespace-nowrap px-1.5 leading-tight">
                    Current Plan
                  </Badge>
                ...
                <h3 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white mb-0.5 text-center flex items-center justify-center gap-0.5 sm:gap-1">
                  <Zap className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-600" />
                  Pro Plan
                </h3>
                <div className="text-center mb-1.5 sm:mb-2">
                  <p className="text-lg sm:text-xl font-bold text-amber-600 dark:text-amber-500">
                    {proPrice}<span className="text-[10px] sm:text-xs">{proPeriod}</span>
                  </p>
          ...
          <div className="space-y-1.5 sm:space-y-2">
            <Button
              onClick={onLogin}
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold h-10 sm:h-11 text-xs sm:text-sm shadow-lg"
            >
            ...
            <Button
              onClick={onClose}
              variant="ghost"
              className="w-full text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 text-[11px] sm:text-xs h-8 sm:h-9"
            >
              Continue as Guest (Free Plan)
            </Button>
            
            <p className="text-center text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400 leading-tight">
