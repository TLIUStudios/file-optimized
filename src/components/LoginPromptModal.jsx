...
export default function LoginPromptModal({ isOpen, onClose, onLogin, context = "general", userPlan = "free" }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-w-[95vw] max-h-[85vh] overflow-y-auto p-0 bg-gradient-to-br from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 [&>button]:hidden">
