...
import { X, MoveHorizontal, ZoomIn, ZoomOut, Maximize2, Copy, RefreshCw, Download as DownloadIcon, Check, Loader2, CheckCircle2, Share2, Cloud, CloudOff, ChevronDown } from "lucide-react";
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56">
                  <DropdownMenuItem disabled className="flex items-center opacity-50 cursor-not-allowed">
                    ...
                    <span className="text-slate-400 whitespace-nowrap flex-1 min-w-0">Google Drive</span>
                    <span className="text-slate-400 text-[10px] whitespace-nowrap ml-2">Coming Soon</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem disabled className="flex items-center opacity-50 cursor-not-allowed">
