...
const ACHIEVEMENTS = {
  ...
  'late_night': { name: 'Late Night Worker', description: 'Compressed 25 files between 11 PM-3 AM', icon: '🌃', color: 'from-indigo-500 to-purple-500' },
  'dawn_patrol': { name: 'Dawn Patrol', description: 'Compressed 25 files between 5 AM-7 AM', icon: '🌅', color: 'from-orange-500 to-yellow-500' },
  ...
  'seo_expert': { name: 'SEO Expert', description: 'Generated SEO data 100 times', icon: '🎯', color: 'from-cyan-500 to-blue-500' },
  'viral_sharer': { name: 'Viral Sharer', description: 'Shared 50 files to social media', icon: '🚀', color: 'from-fuchsia-500 to-pink-500' },
  
  // Conversion Achievements (6)
  ...
  'media_transformer': { name: 'Media Transformer', description: 'Converted between images, videos, and GIFs', icon: '✨', color: 'from-purple-500 to-pink-500' },
  ...
  'helper': { name: 'Community Helper', description: 'Helped 5 users in Discord', icon: '🤝', color: 'from-green-500 to-teal-500' },
  ...
  'settings_guru': { name: 'Settings Guru', description: 'Adjusted 20 different settings', icon: '⚙️', color: 'from-slate-500 to-gray-500' },
  ...
  'detail_master': { name: 'Detail Master', description: 'Compared images 500 times', icon: '🎯', color: 'from-blue-500 to-indigo-500' },
  ...
  'filter_pro': { name: 'Filter Pro', description: 'Applied filters 30 times', icon: '🎨', color: 'from-pink-500 to-rose-500' },
  'adjust_master': { name: 'Adjustment Master', description: 'Adjusted brightness/contrast 40 times', icon: '🌗', color: 'from-slate-500 to-gray-500' },
  ...
  'marathon_session': { name: 'Marathon Session', description: 'Spent 2+ hours optimizing files', icon: '🏃‍♂️', color: 'from-indigo-500 to-purple-500' },
...
// TOTAL: 100 Personal Achievements
// Count: 11 compression + 9 space + 8 format + 4 efficiency + 5 streak + 4 batch + 5 time + 
//        10 feature + 6 conversion + 2 quality + 4 supporter + 6 social + 4 media + 
//        3 advanced tech + 3 size + 4 special + 2 efficiency expert + 5 exploration + 
//        3 milestones + 3 comparison + 5 advanced features + 3 video + 2 audio + 2 gif + 
//        2 early + 6 special milestones + 3 sharing + 4 seasonal + 2 stats + 5 collector = 100

const GLOBAL_ACHIEVEMENTS = {
  // File Count Milestones
  'global_100': { name: 'First Century', description: '100 files optimized', goal: 100, icon: '🎯', color: 'from-blue-400 to-cyan-400' },
  'global_500': { name: 'Getting Started', description: '500 files optimized', goal: 500, icon: '🌟', color: 'from-cyan-500 to-blue-500' },
  'global_1000': { name: 'Community Launch', description: '1,000 files optimized', goal: 1000, icon: '🚀', color: 'from-blue-500 to-cyan-500' },
  'global_2500': { name: 'Rising Together', description: '2,500 files optimized', goal: 2500, icon: '📊', color: 'from-teal-500 to-cyan-500' },
  'global_5000': { name: 'Five Thousand', description: '5,000 files optimized', goal: 5000, icon: '⭐', color: 'from-green-500 to-teal-500' },
  'global_10000': { name: 'Growing Strong', description: '10,000 files optimized', goal: 10000, icon: '🌱', color: 'from-green-500 to-emerald-500' },
  'global_25000': { name: 'Community Power', description: '25,000 files optimized', goal: 25000, icon: '💪', color: 'from-emerald-500 to-green-500' },
  'global_50000': { name: 'Going Viral', description: '50,000 files optimized', goal: 50000, icon: '📈', color: 'from-purple-500 to-pink-500' },
  'global_75000': { name: 'Unstoppable Force', description: '75,000 files optimized', goal: 75000, icon: '🔥', color: 'from-orange-500 to-red-500' },
  'global_100000': { name: 'Six Figures', description: '100,000 files optimized', goal: 100000, icon: '💯', color: 'from-amber-500 to-orange-500' },
  'global_150000': { name: 'Momentum Building', description: '150,000 files optimized', goal: 150000, icon: '🎪', color: 'from-pink-500 to-rose-500' },
  'global_200000': { name: 'Two Hundred K', description: '200,000 files optimized', goal: 200000, icon: '🎭', color: 'from-rose-500 to-red-500' },
  'global_250000': { name: 'Quarter Million', description: '250,000 files optimized', goal: 250000, icon: '🎨', color: 'from-violet-500 to-purple-500' },
  ...
  'global_750000': { name: 'Three Quarters', description: '750,000 files optimized', goal: 750000, icon: '🎊', color: 'from-purple-500 to-indigo-500' },
  ...
  'global_5000000': { name: 'Five Million Milestone', description: '5,000,000 files optimized', goal: 5000000, icon: '💎', color: 'from-cyan-500 to-blue-500' },
  'global_10000000': { name: 'Ten Million Legend', description: '10,000,000 files optimized!', goal: 10000000, icon: '🌌', color: 'from-indigo-500 to-purple-500' },
  
  // Data Saved Milestones
  'global_save_10mb': { name: 'First Savings', description: 'Saved 10 MB together', goal: 10 * 1024 * 1024, icon: '💿', color: 'from-teal-400 to-cyan-400' },
  'global_save_50mb': { name: 'Small Steps', description: 'Saved 50 MB collectively', goal: 50 * 1024 * 1024, icon: '📀', color: 'from-cyan-500 to-teal-500' },
  'global_save_100mb': { name: 'Hundred Megs', description: 'Saved 100 MB together', goal: 100 * 1024 * 1024, icon: '💾', color: 'from-teal-500 to-cyan-500' },
  'global_save_250mb': { name: 'Quarter Gig', description: 'Saved 250 MB as a community', goal: 250 * 1024 * 1024, icon: '🗄️', color: 'from-blue-500 to-cyan-500' },
  'global_save_500mb': { name: 'Half Gigabyte', description: 'Saved 500 MB collectively', goal: 500 * 1024 * 1024, icon: '📦', color: 'from-blue-500 to-indigo-500' },
  ...
  'global_save_2gb': { name: 'Two Gigabytes', description: 'Saved 2 GB worldwide', goal: 2 * 1024 * 1024 * 1024, icon: '🎯', color: 'from-cyan-500 to-blue-500' },
  'global_save_5gb': { name: 'Five Gigs', description: 'Saved 5 GB together', goal: 5 * 1024 * 1024 * 1024, icon: '🏅', color: 'from-green-500 to-teal-500' },
  ...
  'global_save_25gb': { name: 'Twenty Five Gigs', description: 'Saved 25 GB collectively', goal: 25 * 1024 * 1024 * 1024, icon: '🎪', color: 'from-emerald-500 to-teal-500' },
  'global_save_50gb': { name: 'Fifty Gigabytes', description: 'Saved 50 GB as a community', goal: 50 * 1024 * 1024 * 1024, icon: '🚀', color: 'from-purple-500 to-pink-500' },
  'global_save_75gb': { name: 'Seventy Five Gigs', description: 'Saved 75 GB worldwide', goal: 75 * 1024 * 1024 * 1024, icon: '💫', color: 'from-pink-500 to-rose-500' },
  ...
  'global_save_250gb': { name: 'Quarter Terabyte', description: 'Saved 250 GB collectively', goal: 250 * 1024 * 1024 * 1024, icon: '⚡', color: 'from-amber-500 to-orange-500' },
  ...
  'global_save_750gb': { name: 'Three Quarter TB', description: 'Saved 750 GB together', goal: 750 * 1024 * 1024 * 1024, icon: '🔱', color: 'from-rose-500 to-red-500' },
  ...
  'global_save_2tb': { name: 'Two Terabytes', description: 'Saved 2 TB collectively', goal: 2 * 1024 * 1024 * 1024 * 1024, icon: '💠', color: 'from-cyan-500 to-blue-500' },
  'global_save_5tb': { name: 'Five Terabyte Club', description: 'Saved 5 TB worldwide', goal: 5 * 1024 * 1024 * 1024 * 1024, icon: '🔷', color: 'from-blue-500 to-indigo-500' },
  ...
  'global_save_25tb': { name: 'Twenty Five TB', description: 'Saved 25 TB together', goal: 25 * 1024 * 1024 * 1024 * 1024, icon: '🏔️', color: 'from-purple-500 to-pink-500' },
  'global_save_50tb': { name: 'Fifty Terabyte Heroes', description: 'Saved 50 TB as a community', goal: 50 * 1024 * 1024 * 1024 * 1024, icon: '⛰️', color: 'from-emerald-500 to-green-500' },
  'global_save_100tb': { name: 'Hundred TB Legends', description: 'Saved 100 TB worldwide!', goal: 100 * 1024 * 1024 * 1024 * 1024, icon: '🌋', color: 'from-red-500 to-orange-500' },
  
  // User Count Milestones
  'global_10_users': { name: 'First Ten', description: '10 users joined', goal: 10, icon: '👋', color: 'from-blue-400 to-cyan-400' },
  'global_25_users': { name: 'Growing Circle', description: '25 users joined', goal: 25, icon: '👥', color: 'from-cyan-500 to-teal-500' },
  'global_50_users': { name: 'Fifty Strong', description: '50 users joined', goal: 50, icon: '🤝', color: 'from-teal-500 to-green-500' },
  'global_100_users': { name: '100 Optimizers', description: '100 users joined', goal: 100, icon: '👥', color: 'from-cyan-500 to-blue-500' },
  'global_250_users': { name: 'Quarter Thousand', description: '250 users strong', goal: 250, icon: '🌐', color: 'from-green-500 to-emerald-500' },
  'global_500_users': { name: '500 Members', description: '500 users worldwide', goal: 500, icon: '🌍', color: 'from-emerald-500 to-teal-500' },
  'global_1000_users': { name: '1K Community', description: '1,000 users strong', goal: 1000, icon: '🌍', color: 'from-green-500 to-teal-500' },
  'global_2500_users': { name: 'Twenty Five Hundred', description: '2,500 users joined', goal: 2500, icon: '🌎', color: 'from-teal-500 to-cyan-500' },
  'global_5000_users': { name: 'Five Thousand Strong', description: '5,000 users worldwide', goal: 5000, icon: '🌏', color: 'from-blue-500 to-indigo-500' },
  'global_10000_users': { name: '10K Family', description: '10,000 users worldwide', goal: 10000, icon: '🌎', color: 'from-purple-500 to-pink-500' },
  'global_25000_users': { name: 'Twenty Five K', description: '25,000 users strong', goal: 25000, icon: '🌐', color: 'from-pink-500 to-rose-500' },
  'global_50000_users': { name: 'Fifty Thousand', description: '50,000 users joined', goal: 50000, icon: '🌍', color: 'from-rose-500 to-red-500' },
  'global_100000_users': { name: '100K Movement', description: '100,000 users joined', goal: 100000, icon: '🌏', color: 'from-rose-500 to-red-500' },
  'global_250000_users': { name: 'Quarter Million Users', description: '250,000 users strong', goal: 250000, icon: '🌌', color: 'from-indigo-500 to-purple-500' },
  'global_500000_users': { name: 'Half Million Users', description: '500,000 users worldwide', goal: 500000, icon: '🌠', color: 'from-purple-500 to-pink-500' },
  ...
  'global_1000_images': { name: 'Thousand Images', description: '1,000 images optimized', goal: 1000, icon: '🖼️', color: 'from-blue-500 to-cyan-500' },
  'global_10000_images': { name: 'Ten Thousand Images', description: '10,000 images optimized', goal: 10000, icon: '🎨', color: 'from-purple-500 to-pink-500' },
  'global_100000_images': { name: 'Hundred K Images', description: '100,000 images optimized', goal: 100000, icon: '🖼️', color: 'from-pink-500 to-rose-500' },
  'global_500_videos': { name: 'Five Hundred Videos', description: '500 videos optimized', goal: 500, icon: '🎬', color: 'from-red-500 to-orange-500' },
  'global_5000_videos': { name: 'Five K Videos', description: '5,000 videos optimized', goal: 5000, icon: '🎥', color: 'from-orange-500 to-amber-500' },
  ...
  'global_500_audio': { name: 'Five Hundred Audio', description: '500 audio files optimized', goal: 500, icon: '🎵', color: 'from-indigo-500 to-purple-500' },
  'global_5000_audio': { name: 'Five K Audio', description: '5,000 audio files optimized', goal: 5000, icon: '🎧', color: 'from-purple-500 to-pink-500' },
  'global_50000_audio': { name: 'Fifty K Audio', description: '50,000 audio files optimized', goal: 50000, icon: '🎼', color: 'from-pink-500 to-rose-500' },
  
  // Weekly/Monthly Milestones
  'global_1000_week': { name: 'Busy Week', description: '1,000 files in a week', goal: 1000, icon: '📅', color: 'from-green-500 to-emerald-500' },
  'global_5000_week': { name: 'Super Week', description: '5,000 files in a week', goal: 5000, icon: '🗓️', color: 'from-emerald-500 to-teal-500' },
  'global_10000_week': { name: 'Epic Week', description: '10,000 files in a week', goal: 10000, icon: '📆', color: 'from-teal-500 to-cyan-500' },
  'global_10000_month': { name: 'Strong Month', description: '10,000 files in a month', goal: 10000, icon: '🗓️', color: 'from-blue-500 to-indigo-500' },
  'global_50000_month': { name: 'Massive Month', description: '50,000 files in a month', goal: 50000, icon: '📅', color: 'from-indigo-500 to-purple-500' },
  'global_100000_month': { name: 'Legendary Month', description: '100,000 files in a month', goal: 100000, icon: '📆', color: 'from-purple-500 to-pink-500' },
  
  // Consecutive Activity
  'global_7_days': { name: 'Week Streak', description: 'Active 7 days in a row', goal: 7, icon: '🔥', color: 'from-orange-500 to-red-500' },
  'global_30_days': { name: 'Month Streak', description: 'Active 30 days in a row', goal: 30, icon: '🌟', color: 'from-red-500 to-pink-500' },
  'global_100_days': { name: 'Hundred Day Streak', description: 'Active 100 days in a row', goal: 100, icon: '⚡', color: 'from-pink-500 to-rose-500' },
  'global_365_days': { name: 'Year Round', description: 'Active 365 days in a row', goal: 365, icon: '💫', color: 'from-amber-500 to-yellow-500' },
  
  // Efficiency Milestones
  'global_avg_50_savings': { name: 'Efficient Community', description: 'Average 50% savings', goal: 50, icon: '📊', color: 'from-green-500 to-emerald-500' },
  'global_avg_70_savings': { name: 'Super Efficient', description: 'Average 70% savings', goal: 70, icon: '📈', color: 'from-emerald-500 to-teal-500' },
  'global_avg_80_savings': { name: 'Ultra Efficient', description: 'Average 80% savings', goal: 80, icon: '🎯', color: 'from-teal-500 to-cyan-500' },
  
  // Special Events
  'global_holiday_2025': { name: 'Holiday Season 2025', description: '10,000 files during holidays', goal: 10000, icon: '🎄', color: 'from-red-500 to-green-500' },
  'global_newyear_2026': { name: 'New Year 2026', description: '5,000 files on New Year week', goal: 5000, icon: '🎆', color: 'from-indigo-500 to-purple-500' },
  'global_summer_2025': { name: 'Summer 2025', description: '25,000 files during summer', goal: 25000, icon: '☀️', color: 'from-yellow-500 to-orange-500' },
  
  // Pro Members
  'global_100_pro': { name: '100 Pro Members', description: '100 Pro subscriptions', goal: 100, icon: '⭐', color: 'from-amber-500 to-yellow-500' },
  'global_500_pro': { name: '500 Pro Members', description: '500 Pro subscriptions', goal: 500, icon: '👑', color: 'from-yellow-500 to-orange-500' },
  'global_1000_pro': { name: '1K Pro Members', description: '1,000 Pro subscriptions', goal: 1000, icon: '💎', color: 'from-orange-500 to-red-500' },
  'global_5000_pro': { name: '5K Pro Members', description: '5,000 Pro subscriptions', goal: 5000, icon: '🔥', color: 'from-red-500 to-pink-500' },
  
  // Batch Processing (3)
  'global_10000_batch': { name: 'Batch Processing', description: '10,000 batch uploads', goal: 10000, icon: '📚', color: 'from-blue-500 to-indigo-500' },
  'global_50000_batch': { name: 'Batch Masters', description: '50,000 batch uploads', goal: 50000, icon: '📑', color: 'from-indigo-500 to-purple-500' },
  'global_100000_batch': { name: 'Batch Legends', description: '100,000 batch uploads', goal: 100000, icon: '🗂️', color: 'from-purple-500 to-pink-500' },
  
  // Downloads (4)
  'global_10000_downloads': { name: 'Download Milestone', description: '10,000 files downloaded', goal: 10000, icon: '⬇️', color: 'from-blue-500 to-cyan-500' },
  'global_50000_downloads': { name: 'Download Heroes', description: '50,000 files downloaded', goal: 50000, icon: '📥', color: 'from-cyan-500 to-teal-500' },
  'global_100000_downloads': { name: 'Download Champions', description: '100,000 files downloaded', goal: 100000, icon: '💾', color: 'from-teal-500 to-green-500' },
  'global_1000_zips': { name: 'ZIP Masters', description: '1,000 ZIP archives created', goal: 1000, icon: '🗜️', color: 'from-purple-500 to-pink-500' },
  
  // Performance (6)
  'global_avg_5mb': { name: 'Average 5MB Savings', description: 'Average 5MB saved per file', goal: 5, icon: '📊', color: 'from-green-500 to-teal-500' },
  'global_avg_10mb': { name: 'Average 10MB Savings', description: 'Average 10MB saved per file', goal: 10, icon: '📈', color: 'from-teal-500 to-cyan-500' },
  'global_peak_hour': { name: 'Peak Hour', description: '1,000 files in one hour', goal: 1000, icon: '⏱️', color: 'from-orange-500 to-red-500' },
  'global_peak_day': { name: 'Peak Day', description: '10,000 files in one day', goal: 10000, icon: '🔥', color: 'from-red-500 to-pink-500' },
  'global_fastest_growth': { name: 'Fastest Growth', description: '1,000 new users in 24h', goal: 1000, icon: '🚀', color: 'from-pink-500 to-rose-500' },
  'global_community_milestone': { name: 'Community Milestone', description: '100,000 total uploads + downloads', goal: 100000, icon: '🎊', color: 'from-violet-500 to-fuchsia-500' },
};

// TOTAL: 100 Global Achievements  
// Count: 19 file count + 23 data saved + 16 user count + 9 format specific + 
//        6 weekly/monthly + 4 consecutive + 3 efficiency + 3 special events + 
//        4 pro members + 3 batch + 4 downloads + 6 performance = 100
