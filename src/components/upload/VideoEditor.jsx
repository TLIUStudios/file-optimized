...
import { X, Play, Pause, RotateCw, Crop, Type, Blur, Zap, Download, Scissors } from "lucide-react";
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <Input
                          type="number"
                          value={blurX}
                          onChange={(e) => setBlurX(parseInt(e.target.value) || 0)}
                          className="mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          type="number"
                          value={blurY}
                          onChange={(e) => setBlurY(parseInt(e.target.value) || 0)}
                          className="mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          type="number"
                          value={blurWidth}
                          onChange={(e) => setBlurWidth(parseInt(e.target.value) || 0)}
                          className="mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          type="number"
                          value={blurHeight}
                          onChange={(e) => setBlurHeight(parseInt(e.target.value) || 0)}
                          className="mt-1"
                        />
                      </div>
                    </div>
