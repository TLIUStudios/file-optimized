          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-8 text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-5 flex-wrap">
              ...
              <a href="https://music.apple.com/us/artist/tliu-studios/1836817405" target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-500 hover:text-white dark:hover:text-white transition-colors" aria-label="Apple Music">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.5 18c-1.38 0-2.5-1.12-2.5-2.5S7.12 13 8.5 13c.76 0 1.44.35 1.9.89V6.72L18 5v7.78c0 1.38-1.12 2.5-2.5 2.5S13 14.16 13 12.78c0-.76.35-1.44.89-1.9V3l9 2v11.28c0 1.38-1.12 2.5-2.5 2.5s-2.5-1.12-2.5-2.5c0-.76.35-1.44.89-1.9V8.5l-8.39 1.86v7.14c0 1.38-1.12 2.5-2.5 2.5z"/>
                </svg>
              </a>
              <a href="https://music.amazon.ca/artists/B0FPC89Q2D/tliu-studios" target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-500 hover:text-white dark:hover:text-white transition-colors" aria-label="Amazon Music">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.427 14.857c-2.563.778-5.197 1.177-7.832 1.177-3.706 0-7.042-.683-9.595-1.818-.53-.235-.059-.558.589-.412 2.952.853 6.603 1.367 10.377 1.367 2.545 0 5.342-.53 7.912-1.618.389-.165.713.257.384.608l-.835.696zm.887 1.012c-.327.416-2.165.197-2.987.099-.248-.03-.287-.186-.063-.343 1.468-1.029 3.879-.731 4.157-.387.28.347-.073 2.744-1.447 3.888-.212.176-.414.083-.32-.15.31-.769 1.003-2.49.66-3.107z"/>
                </svg>
              </a>
