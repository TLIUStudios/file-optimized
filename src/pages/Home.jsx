          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-6 shadow-lg">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                {statsLoading ? (
                  <div className="h-10 w-32 bg-emerald-200/50 dark:bg-emerald-800/50 rounded-lg animate-pulse" />
                ) : (
                  <motion.p
              ...
              {statsLoading ? (
                <div className="h-5 w-48 bg-slate-200 dark:bg-slate-700 rounded mx-auto animate-pulse" />
              ) : (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
