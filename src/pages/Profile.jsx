              ...
              <div className="space-y-2">
                ...
                <Button variant="outline" className="w-full justify-start" asChild>
                  <a href="https://music.apple.com/us/artist/tliu-studios/1836817405" target="_blank" rel="noopener noreferrer">
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="#FA243C" xmlns="http://www.w3.org/2000/svg">
                      <path d="M23.997 6.124a9.23 9.23 0 00-.24-2.19c-.317-1.31-1.062-2.31-2.18-3.043a5.022 5.022 0 00-1.877-.726 10.496 10.496 0 00-1.564-.15c-.04-.003-.083-.01-.124-.013H5.986c-.152.01-.303.017-.455.026-.747.043-1.49.123-2.193.4-1.336.53-2.3 1.45-2.865 2.78-.192.448-.292.925-.363 1.408a10.61 10.61 0 00-.1 1.18c0 .032-.007.062-.01.093v12.223c.01.14.017.283.027.424.05.815.154 1.62.497 2.373.65 1.42 1.738 2.353 3.234 2.801.42.127.856.187 1.293.228.555.053 1.11.06 1.667.06h11.03a12.5 12.5 0 001.57-.1c.822-.106 1.596-.35 2.296-.81a5.046 5.046 0 002.127-2.962c.183-.68.258-1.375.292-2.074.01-.202.017-.405.025-.607V6.124zM9.05 4.364h5.9c.088 0 .175.008.263.008.04.004.08.013.12.02.865.166 1.415.74 1.534 1.62.043.326.043.65.043.976v8.426c0 .588-.227.947-.748 1.138a1.63 1.63 0 01-1.52-.254 1.595 1.595 0 01-.507-1.003c-.027-.196-.05-.392-.05-.588V7.084c0-.223-.052-.446-.088-.668-.11-.674-.65-1.177-1.324-1.24-.22-.02-.442-.02-.663-.02H9.05c-.065 0-.13-.007-.195-.01a1.55 1.55 0 00-1.392.737c-.196.294-.267.626-.267.97v8.422c0 .065-.007.13-.01.196a1.626 1.626 0 01-1.254 1.524 1.634 1.634 0 01-1.803-.907c-.093-.196-.146-.405-.146-.617V7.084c0-.588.227-.947.747-1.138.42-.154.853-.19 1.29-.19h2.83z"/>
                    </svg>
                    Apple Music
                  </a>
                </Button>
                    ...
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="amazonGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                          ...
                          <stop offset="100%" style={{stopColor: '#7B2BFF', stopOpacity: 1}} />
                        </linearGradient>
                      </defs>
                      <path fill="url(#amazonGradient)" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.5 17.5c-.3.4-.8.5-1.2.2-2.1-1.7-4.8-1.9-7.9-1-1 .2-1.4-.6-1.2-1.2.2-1 .6-1 1.6-1.2 3.4-.9 6.5-.5 9 1.5.5.3.6.8.3 1.2zm1.7-3.7c-.4.5-1 .7-1.5.4-2.4-1.5-6.1-1.9-9-1-.6.1-1.2-.3-1.3-.9-.1-.6.3-1.2.9-1.3 3.2-.9 7.3-.5 10.1 1.2.5.3.7 1 .4 1.6zm1.6-3.8c-2.8-1.7-7.4-1.8-10.1-1-.8.2-1.6-.3-1.8-1.1-.2-.8.3-1.6 1.1-1.8 3.1-.9 8.2-.7 11.5 1.2.7.4 1 1.3.6 2-.4.7-1.3 1-2 .6z"/>
                    </svg>
                    Amazon Music
                  </a>
                </Button>
