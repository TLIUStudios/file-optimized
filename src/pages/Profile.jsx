              ...
              <Card className="p-6">
                ...
                <div className="space-y-2">
                  <Button disabled className="w-full" variant="outline">
                    ...
                    Connect to Google Drive <span className="ml-2 text-xs">(Coming Soon)</span>
                  </Button>
                  <Button disabled className="w-full" variant="outline">
                    ...
                    Connect to Dropbox <span className="ml-2 text-xs">(Coming Soon)</span>
                  </Button>
                  <Button disabled className="w-full" variant="outline">
                    <svg className="w-4 h-4 mr-2 opacity-40" viewBox="0 0 24 24" fill="#0078D4">
                    ...
                    Connect to OneDrive <span className="ml-2 text-xs">(Coming Soon)</span>
                  </Button>
                </div>
              </Card>
            </motion.div>
